...
!Data: 06/07/2021
!Problema: Vamos fazer um levantamento de dados gravimétricos para um modelo de
!um cilindro na subsuperfície com raio R, comprimento L, densidade p e num ponto x.
!Será utilizado a subrotina trapezios para calcular a integral de Iy que nos dará a resposta,
!que será escrita em um arquivo externo dados_outuput.dat
